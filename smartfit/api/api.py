...
def get_recommended_routines(request: Request, response: Response):
    try:
        ...
        if recommended_routines == None:
            ...
            logger.error("Invalid workout table. Could not get recommended routines.")
...
# - [US.13] As a future consumer, I would like to create a profile to be able to use
# the app and stay fit and healthy
...
def update_user_fitness_profile(
    id: int, user_fitness_profile: FitnessProfileModel, response: Response
):
